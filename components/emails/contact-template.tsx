...
const ContactTemplate: React.FC<ContactEmailProps> = ({ name, email, message }) => {
        ...
        <Body className="mx-auto my-auto bg-white px-2 font-sans">
          <Container className="mx-auto my-[40px] max-w-[465px] rounded border border-solid border-[#eaeaea] p-[20px]">
            ...
            <Text className="text-[12px] leading-[24px] text-[#666666]">
              This message was automatically generated and sent from your Portfolio Website.
            </Text>
          </Container>
        </Body>
      </Tailwind>
...
// Define preview props separately
export const previewProps: ContactEmailProps = {
  name: 'Jane Doe',
  email: 'jane@example.com',
  message: `Hello! This is Jane Doe, from Example. Just wanted to say hi!`
};
